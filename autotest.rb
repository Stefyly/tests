...
# expect(b.url).to eql("https://weblium.com/")
# goto_login_page()
# expect(get_title()).to eql("Log in")
# login("weblium1@gmail.com", 123124)
# expect(get_login_error_text()).to eql("Invalid email or password")
# set_pass(123123)
# click_login_button()
# hover_goto_site_settings(1)
# expect(get_title()).to eql("Manage general settings")
# site_name = get_site_name_from_banner()
# set_save_site_name(site_name + "_test")
# expect(get_site_name_from_banner()).to eql(site_name + "_test")
# goto_my_websites()
# expect(check_site_name()).to eql(site_name + "_test")
# hover_goto_site_settings(1)
# set_save_site_name(site_name)
# expect(get_site_name_from_banner()).to eql(site_name)
# b.close